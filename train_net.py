...
from DenoiseDiff.config import add_diffusion_config
    ...
    def build_optimizer(cls, cfg, model):
        ...
        for module_name, module in model.named_modules():
            for module_param_name, value in module.named_parameters(recurse=False):
                ...
                if "diffopenseg.diff" in module_name :
                    hyperparams["lr"] = hyperparams["lr"] * cfg.SOLVER.DIFFUSION_MULTIPLIER
                # for deformable detr
...
def get_parser():
    parser = argparse.ArgumentParser(description="DEDOS / Detectron2 Training")
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Machine rank for multi-machine training",
    )
